...
#define PG_VERSION "12.5 (Ubuntu 12.5-0ubuntu0.20.04.1)"

/* PostgreSQL version as a number */
#define PG_VERSION_NUM 120005

/* A string containing the version number, platform, and C compiler */
#define PG_VERSION_STR "PostgreSQL 12.5 (Ubuntu 12.5-0ubuntu0.20.04.1) on x86_64-pc-linux-gnu, compiled by gcc (Ubuntu 9.3.0-17ubuntu1~20.04) 9.3.0, 64-bit"
